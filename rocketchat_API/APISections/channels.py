...
class RocketChatChannels(RocketChatBase):
    async def channels_list(self, **kwargs):
        ...
        return await self.call_api_get("channels.list", kwargs=kwargs)

    async def channels_list_joined(self, **kwargs):
        """Lists all of the channels the calling user has joined"""
        return await self.call_api_get("channels.list.joined", kwargs=kwargs)

    async def channels_info(self, room_id=None, channel=None, **kwargs):
        """Gets a channel's information."""
        if room_id:
            return await self.call_api_get("channels.info", roomId=room_id, kwargs=kwargs)
        if channel:
            return await self.call_api_get("channels.info", roomName=channel, kwargs=kwargs)
        raise RocketMissingParamException("room_id or channel required")

    async def channels_history(self, room_id, **kwargs):
        """Retrieves the messages from a channel."""
        return await self.call_api_get("channels.history", roomId=room_id, kwargs=kwargs)

    async def channels_add_all(self, room_id, **kwargs):
        """Adds all of the users of the Rocket.Chat server to the channel."""
        return await self.call_api_post("channels.addAll", roomId=room_id, kwargs=kwargs)
    ...
    async def channels_moderators(self, room_id=None, channel=None, **kwargs):
    ...
    async def channels_archive(self, room_id, **kwargs):
        """Archives a channel."""
        return await self.call_api_post("channels.archive", roomId=room_id, kwargs=kwargs)

    async def channels_unarchive(self, room_id, **kwargs):
        """Unarchives a channel."""
        return await self.call_api_post("channels.unarchive", roomId=room_id, kwargs=kwargs)

    async def channels_close(self, room_id, **kwargs):
        """Removes the channel from the user's list of channels."""
        return await self.call_api_post("channels.close", roomId=room_id, kwargs=kwargs)

    async def channels_open(self, room_id, **kwargs):
        """Adds the channel back to the user's list of channels."""
        return await self.call_api_post("channels.open", roomId=room_id, kwargs=kwargs)

    async def channels_create(self, name, **kwargs):
        """Creates a new public channel, optionally including users."""
        return await self.call_api_post("channels.create", name=name, kwargs=kwargs)
    ...
    async def channels_join(self, room_id, join_code, **kwargs):
    ...
    async def channels_leave(self, room_id, **kwargs):
        ...
        return await self.call_api_post("channels.leave", roomId=room_id, kwargs=kwargs)
    ...
    async def channels_set_default(self, room_id, default, **kwargs):
    ...
    async def channels_set_announcement(self, room_id, announcement, **kwargs):
    ...
    async def channels_delete(self, room_id=None, channel=None, **kwargs):
        ...
        if room_id:
            return await self.call_api_post("channels.delete", roomId=room_id, kwargs=kwargs)
        if channel:
            return await self.call_api_post(
    ...
    async def channels_members(self, room_id=None, channel=None, **kwargs):
        ...
        if room_id:
            return await self.call_api_get("channels.members", roomId=room_id, kwargs=kwargs)
        if channel:
            return await self.call_api_get(
    ...
    async def channels_roles(self, room_id=None, room_name=None, **kwargs):
        ...
        if room_id:
            return await self.call_api_get("channels.roles", roomId=room_id, kwargs=kwargs)
        if room_name:
            return await self.call_api_get(
    ...
    async def channels_files(self, room_id=None, room_name=None, **kwargs):
        ...
        if room_id:
            return await self.call_api_get("channels.files", roomId=room_id, kwargs=kwargs)
        if room_name:
            return await self.call_api_get(
    ...
    async def channels_counters(self, room_id=None, room_name=None, **kwargs):
        """Gets counters for a channel."""
        if room_id:
            return await self.call_api_get("channels.counters", roomId=room_id, kwargs=kwargs)
        if room_name:
            return await self.call_api_get(
    ...
    async def channels_online(self, query):
        """Lists all online users of a channel if the channel's id is provided, otherwise it gets all online users of
        all channels."""
        return await self.call_api_get("channels.online", query=json.dumps(query))
