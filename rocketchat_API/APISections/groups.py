...
class RocketChatGroups(RocketChatBase):
    async def groups_list_all(self, **kwargs):
        ...
        """
        return await self.call_api_get("groups.listAll", kwargs=kwargs)

    async def groups_list(self, **kwargs):
        """List the private groups the caller is part of."""
        return await self.call_api_get("groups.list", kwargs=kwargs)

    async def groups_history(self, room_id, **kwargs):
        """Retrieves the messages from a private group."""
        return await self.call_api_get("groups.history", roomId=room_id, kwargs=kwargs)
    ...
    async def groups_moderators(self, room_id=None, group=None, **kwargs):
        """Lists all moderators of a group."""
        if room_id:
            return await self.call_api_get("groups.moderators", roomId=room_id, kwargs=kwargs)
        if group:
            return await self.call_api_get("groups.moderators", roomName=group, kwargs=kwargs)
    ...
    async def groups_archive(self, room_id, **kwargs):
        ...
        return await self.call_api_post("groups.archive", roomId=room_id, kwargs=kwargs)

    async def groups_unarchive(self, room_id, **kwargs):
        """Unarchives a private group."""
        return await self.call_api_post("groups.unarchive", roomId=room_id, kwargs=kwargs)
    ...
    async def groups_close(self, room_id, **kwargs):
        ...
        return await self.call_api_post("groups.close", roomId=room_id, kwargs=kwargs)
    ...
    async def groups_create(self, name, **kwargs):
        ...
        return await self.call_api_post("groups.create", name=name, kwargs=kwargs)
    ...
    async def groups_info(self, room_id=None, room_name=None, **kwargs):
        ...
        if room_id:
            return await self.call_api_get("groups.info", roomId=room_id, kwargs=kwargs)
        if room_name:
            return await self.call_api_get("groups.info", roomName=room_name, kwargs=kwargs)
    ...
    async def groups_leave(self, room_id, **kwargs):
        ...
        return await self.call_api_post("groups.leave", roomId=room_id, kwargs=kwargs)

    async def groups_open(self, room_id, **kwargs):
        """Adds the private group back to the user's list of private groups."""
        return await self.call_api_post("groups.open", roomId=room_id, kwargs=kwargs)
    ...
    async def groups_set_announcement(self, room_id, announcement, **kwargs):
    ...
    async def groups_set_custom_fields(
    ...
    async def groups_delete(self, room_id=None, group=None, **kwargs):
        ...
        if room_id:
            return await self.call_api_post("groups.delete", roomId=room_id, kwargs=kwargs)
        if group:
            return await self.call_api_post("groups.delete", roomName=group, kwargs=kwargs)
        raise RocketMissingParamException("room_id or group required")

    async def groups_members(self, room_id=None, group=None, **kwargs):
        """Lists all group users."""
        if room_id:
            return await self.call_api_get("groups.members", roomId=room_id, kwargs=kwargs)
        if group:
            return await self.call_api_get("groups.members", roomName=group, kwargs=kwargs)
        raise RocketMissingParamException("room_id or group required")

    async def groups_roles(self, room_id=None, room_name=None, **kwargs):
        """Lists all user's roles in the private group."""
        if room_id:
            return await self.call_api_get("groups.roles", roomId=room_id, kwargs=kwargs)
        if room_name:
            return await self.call_api_get("groups.roles", roomName=room_name, kwargs=kwargs)
        raise RocketMissingParamException("room_id or room_name required")

    async def groups_files(self, room_id=None, room_name=None, **kwargs):
        """Retrieves the files from a private group."""
        if room_id:
            return await self.call_api_get("groups.files", roomId=room_id, kwargs=kwargs)
        if room_name:
            return await self.call_api_get("groups.files", roomName=room_name, kwargs=kwargs)
        raise RocketMissingParamException("room_id or room_name required")

    async def groups_add_leader(self, room_id, user_id, **kwargs):
        """Gives the role of Leader for a user in the current group."""
        return await self.call_api_post(
            "groups.addLeader", roomId=room_id, userId=user_id, kwargs=kwargs
        )

    async def groups_remove_leader(self, room_id, user_id, **kwargs):
