...
class RocketChatUsers(RocketChatBase):
    async def me(self, **kwargs):
        ...
        return await self.call_api_get("me", kwargs=kwargs)

    async def users_info(self, user_id=None, username=None, **kwargs):
        """Gets a user's information, limited to the caller's permissions."""
        if user_id:
            return await self.call_api_get("users.info", userId=user_id, kwargs=kwargs)
        if username:
            return await self.call_api_get("users.info", username=username, kwargs=kwargs)
    ...
    async def users_list(self, **kwargs):
        ...
        return await self.call_api_get("users.list", kwargs=kwargs)

    async def users_get_presence(self, user_id=None, username=None, **kwargs):
        """Gets the online presence of the a user."""
        if user_id:
            return await self.call_api_get("users.getPresence", userId=user_id, kwargs=kwargs)
        if username:
    ...
    async def users_delete(self, user_id, **kwargs):
        """Deletes a user"""
        return await self.call_api_post("users.delete", userId=user_id, **kwargs)
    ...
    async def users_get_avatar(self, user_id=None, username=None, **kwargs):
        ...
        if user_id:
            response = await self.call_api_get(
    ...
    async def users_set_avatar(self, avatar_url, **kwargs):
        ...
        return await self.call_api_post("users.setAvatar", files=avatar_file, kwargs=kwargs)
    ...
    async def users_update(self, user_id, **kwargs):
        ...
        return await self.call_api_post("users.update", userId=user_id, data=kwargs)

    async def users_set_active_status(self, user_id, active_status, **kwargs):
    ...
    async def users_forgot_password(self, email, **kwargs):
        ...
        return await self.call_api_post("users.forgotPassword", email=email, data=kwargs)

    async def users_get_preferences(self, **kwargs):
        """Gets all preferences of user."""
        return await self.call_api_get("users.getPreferences", kwargs=kwargs)
    ...
    async def users_set_status(self, message, **kwargs):
        """Sets a user Status when the status message and state is given."""
        return await self.call_api_post("users.setStatus", message=message, kwargs=kwargs)